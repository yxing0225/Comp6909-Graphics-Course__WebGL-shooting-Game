...
//Calculate the three parameters of lookAt through the movement of the mouse
//Encapsulates a camera object
//rx corresponds to the movement of the mouse in the X direction, ry corresponds to the movement of the mouse in the Y direction, these can be obtained by mouse listener
(function() {
    var camera = {
        rx: 0,
        ry: 0,
